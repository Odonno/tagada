...
namespace Tagada
{
    ...
    {
        public static TagadaBuilder Put(this TagadaBuilder tagadaBuilder, string path, Action action)
        {
            ...
            tagadaBuilder.AddSwaggerOperationFunc(path, SwaggerOperationMethod.Put, addSwaggerOperation);

            return tagadaBuilder;
        }

        public static TagadaBuilder Put<TResult>(this TagadaBuilder tagadaBuilder, string path, Func<TResult> function)
        {
            void addRoute(RouteBuilder routeBuilder)
            {
                routeBuilder.MapPut(path.TrimStart('/'), async (request, response, routeData) =>
